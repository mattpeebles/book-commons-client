...
export const fetchWishlists = () => (dispatch, getState) => {
    ...
    //resets wishlist state to initial state
...
export const toggleEditWishlistStatus = (list) => ({
    ...
    // save ebook to wishlist actions
    ...
    // remove book from wishlist actions
